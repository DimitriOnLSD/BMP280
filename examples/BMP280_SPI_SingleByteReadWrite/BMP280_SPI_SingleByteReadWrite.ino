...
//Define Chip Select for SPI communication
#define CS_PIN 49
...
//This variables travels between 2 functions so we have to declare it outside loop and setup
double temp_fine;
...
void setup(){
  ...
  Serial.println("-45ºC ... 80ºC");
  Serial.print("Pressure range: ");
  Serial.println("300hPa ... 1100hPa");
  Serial.println("");
